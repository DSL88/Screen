...
const apiBridge = {
  ...
  exportRecommendationsToTrackerBatch: (assets) => ipcRenderer.invoke('export-recommendations-tracker-batch', assets),
  exportSplitAnalysis: (payload) => ipcRenderer.invoke('export-split-analysis', payload),
  saveTop20Tracker: (top20) => ipcRenderer.invoke('save-top20-tracker', top20),
  saveQualifiedMonitoring: (list) => ipcRenderer.invoke('save-qualified-monitoring', list),
  saveMonitoringUniverseBatch: (assets) => ipcRenderer.invoke('save-monitoring-universe-batch', assets),
  getMonitoringUniverseRecords: () => ipcRenderer.invoke('get-monitoring-universe-records'),
  saveMonitoringUniverse: (data) => ipcRenderer.invoke('save-monitoring-universe', data),
  getTrackerTable: () => ipcRenderer.invoke('get-tracker-table'),
  checkAssetTracked: (ticker) => ipcRenderer.invoke('check-asset-tracked', ticker),
  addTrackedInvestmentSafe: (asset) => ipcRenderer.invoke('add-tracked-investment-safe', asset),
  getDuplicateTrackedAssets: () => ipcRenderer.invoke('get-duplicate-tracked-assets'),
  deleteDuplicateTrackedAssets: () => ipcRenderer.invoke('delete-duplicate-tracked-assets'),
  deleteTrackedAssetsByIds: (ids) => ipcRenderer.invoke('delete-tracked-assets-by-ids', ids),
  clearAllTrackerData: () => ipcRenderer.invoke('clear-all-tracker-data'),
  getMonitoringTable: () => ipcRenderer.invoke('get-monitoring-table'),
  getTop20Tracker: (date) => ipcRenderer.invoke('get-top20-tracker', date),
  getMonitoringUniverse: (date) => ipcRenderer.invoke('get-monitoring-universe', date),
  evaluateMonitoringDaily: () => ipcRenderer.invoke('evaluate-monitoring-daily'),
